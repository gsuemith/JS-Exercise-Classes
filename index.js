...
class Airplane {
 ...
 class Instructor extends Lambdasian {
   ...
   grade(student, subject) {
    //  student.grades.push(Math.floor(Math.random() * 50) + 50)
    //  let newGrade = student.map(student => student.grade).reduce((avg, score) => avg + score)
    //  newGrade /= student.grades.length;
